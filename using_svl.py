# -*- coding: utf-8 -*-
"""
Created on Tue Oct  4 22:06:13 2022
...
img_index = 19000 # <<<<<  You can update this value to look at other images
...
for i in range(len(files)):
  img = cv2.imread("C:/R_projects/ocr_fr/images/"+files[i],cv2.IMREAD_GRAYSCALE)
...
import matplotlib.pyplot as plt
plt.imshow(processed_story[1]) #<<< change this index if you want to see a different letter from the story
